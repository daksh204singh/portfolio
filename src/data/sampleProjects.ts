export const sampleProjects = [
  {
    ...
    thumbnail: typeof window !== 'undefined' && (window.location.pathname.startsWith('/portfolio') || window.location.hostname.includes('github.io')) ? '/portfolio/images/robot-system.gif' : '/images/robot-system.gif',
...
Contributed to the end-to-end system setup, including foundational environment configuration, sensor integration using URDF, and SLAM pipeline configuration to process Lidar data for mapping.`,
  ...
  },
  {
    ...
    thumbnail: typeof window !== 'undefined' && (window.location.pathname.startsWith('/portfolio') || window.location.hostname.includes('github.io')) ? '/portfolio/images/pokecache.gif' : '/images/pokecache.gif',
...
The system leverages LLMs to generate and optimize cache replacement algorithms, then uses evolutionary search to refine and improve the generated policies. This approach demonstrates the potential of AI-assisted hardware optimization.`,
  ...
  },
  {
    ...
    thumbnail: typeof window !== 'undefined' && (window.location.pathname.startsWith('/portfolio') || window.location.hostname.includes('github.io')) ? '/portfolio/images/bitonic-sort.gif' : '/images/bitonic-sort.gif',
...
The project explores different parallel computing paradigms and their effectiveness for sorting algorithms, providing insights into performance optimization for large-scale data processing.`,
  ...
  },
  {
    ...
    thumbnail: typeof window !== 'undefined' && (window.location.pathname.startsWith('/portfolio') || window.location.hostname.includes('github.io')) ? '/portfolio/images/os-kernel.gif' : '/images/os-kernel.gif',
